...
class ReceptionistScenarioV1(AbstractScenario):
    ...
    def manual_scenario(self):
        ...
        result = self._lm_wrapper.generic_global("AskPeople1","Ask people name and preference",30," Please can you come closer and saying your name ?",
                        description="Please can you come clother and saying your name ?",
                        type="question",
                        wait_answer=True,
        ...
        #TODO CALL YOLO to find free space
