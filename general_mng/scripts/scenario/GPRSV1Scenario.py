...
class GPRSV1Scenario(AbstractScenario,AbstractScenarioBus,AbstractScenarioAction):
    ...
    def startScenario(self):
        ...
        #	"everywhere"
        #	"<room name>" (room_kitchen, room_living_room, room_dining_room, room_bed_room, room_cooridoor room_entrance room_exit)
        #	"<beacon_name>" (beacon_storage_table,beacon_bookcase, beacon_cupboard, beacon_desk, beacon_dinning_table, beacon_end_table, beacon_side_table, beacon_counter,
        # beacon_sink, beacon_couch, beacon_entrance, beacon_dishwasher  
...
#
        ...
        #orderState02=self.sendNavOrderAction("NP","CRRCloseToGoal","GPRS_OBJECT_KITCHEN_It2",60.0)
        ...
        orderState1,result1=self.sendDialogueOrderAction("GPRS/OrdersStart","GPRS/OrdersFinish",60.0*3)
